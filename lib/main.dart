...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Firebase Authentification'),
    );
  }
}
                      ...
                      child: Material(
                        ...
                        child: InkWell(
                          onTap: () async {
                              ...
                              if(login.text.isEmpty && phone.text.isNotEmpty){
                              ...
                              }else if((login.text.isNotEmpty && phone.text.isEmpty) || (login.text.isNotEmpty && phone.text.isNotEmpty)) {
                                try {
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Заполните одно из полей')));
                              }
                          },
                          ...
                          child: const Align(
                              ...
                              child: Text("Войти по ссылке/Номеру телефона", textAlign: TextAlign.center)),
                        ),
                      ),
                    ),
                    const Padding(padding: EdgeInsets.only(bottom: 35)),
